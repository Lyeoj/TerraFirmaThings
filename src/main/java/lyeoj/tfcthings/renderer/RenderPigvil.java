...
public class RenderPigvil extends RenderLiving<EntityPigvil> {
    ...
    public static final PigvilFactory FACTORY = new PigvilFactory();
    ...
    public static class PigvilFactory implements IRenderFactory<EntityPigvil> {
        @Override
        public Render<? super EntityPigvil> createRenderFor(RenderManager manager) {
            return new RenderPigvil(manager);
        }
    }
